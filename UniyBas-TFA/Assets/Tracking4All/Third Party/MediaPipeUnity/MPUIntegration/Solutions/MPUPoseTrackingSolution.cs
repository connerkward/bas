...
using ModelComplexity = Mediapipe.Unity.Sample.PoseTracking.PoseTrackingGraph.ModelComplexity;
    ...
    ILandmarkProvider<MPPoseLandmarks>, INormalizedLandmarkProvider<MPPoseLandmarks>
{
    ...
    {
        base.OnEnable();
        SettingsManager.Instance.AddSetting(modelSettings.modelComplexity);
    }
    protected override void OnDisable()
    {
        base.OnDisable();
        SettingsManager.Instance.RemoveSetting(modelSettings.modelComplexity.Name);
    }
    ...
    float IProvider<MPPoseLandmarks, Landmark>.TimeSinceLastUpdate => landmarks.TimeSinceLastUpdate;
    float IProvider<MPPoseLandmarks, NormalizedLandmark>.TimeSinceLastUpdate => normalizedLandmarks.TimeSinceLastUpdate;
    ...
    public NormalizedLandmark Get(int group, MPPoseLandmarks index)
    {
