...
namespace Tracking4All
{
    ...
    public class Tracking4All : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="timeSinceUpdate">The time since update value from the provider.</param>
        /// <returns></returns>
        public bool IsProviderLive(float timeSinceUpdate)
        {
            return timeSinceUpdate < providerAliveThreshold;
        }
