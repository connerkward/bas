...
// Modifications licensed under Tracking4All license
...
{
    public readonly struct HolisticPHTrackingResult
    {
        ...
        public readonly LandmarkList leftHandWorldLandmarks;
        public readonly NormalizedLandmarkList rightHandLandmarks;
        public readonly LandmarkList rightHandWorldLandmarks;
        ...
        public HolisticPHTrackingResult(Detection poseDetection, NormalizedLandmarkList poseLandmarks, NormalizedLandmarkList leftHandLandmarks,
                                      ...
                                      LandmarkList leftHand, LandmarkList rightHand)
        {
            ...
            this.leftHandWorldLandmarks = leftHand;
            this.rightHandWorldLandmarks = rightHand;
        }
    }

    public class HolisticPHTrackingGraph : GraphRunner
    {
        ...
        public event EventHandler<OutputStream<LandmarkList>.OutputEventArgs> OnLeftHandWorldLandmarksOutput
        {
            add => _leftHandWorldLandmarksStream.AddListener(value, timeoutMicrosec);
            remove => _leftHandWorldLandmarksStream.RemoveListener(value);
        }

        public event EventHandler<OutputStream<LandmarkList>.OutputEventArgs> OnRightHandWorldLandmarksOutput
        {
            add => _rightHandWorldLandmarksStream.AddListener(value, timeoutMicrosec);
        ...
        private OutputStream<LandmarkList> _leftHandWorldLandmarksStream;
        private OutputStream<NormalizedLandmarkList> _rightHandLandmarksStream;
        private OutputStream<LandmarkList> _rightHandWorldLandmarksStream;
        ...
        public override void StartRun(ImageSource imageSource)
        {
            if (runningMode.IsSynchronous())
            {
                ...
                _leftHandWorldLandmarksStream.StartPolling();
                _rightHandLandmarksStream.StartPolling();
                _rightHandWorldLandmarksStream.StartPolling();
        ...
        public async Task<HolisticPHTrackingResult> WaitNextAsync()
        {
            var results = await WhenAll(
              ...
              _leftHandWorldLandmarksStream.WaitNextAsync(),
              _rightHandLandmarksStream.WaitNextAsync(),
              _rightHandWorldLandmarksStream.WaitNextAsync(),
            ...
            _ = TryGetValue(results.Item3.packet, out var leftHandLandmarks, (packet) =>
            {
                return packet.Get(NormalizedLandmarkList.Parser);
            });
            _ = TryGetValue(results.Item4.packet, out var leftHandWorldLandmarks, (packet) =>
            {
            ...
            _ = TryGetValue(results.Item6.packet, out var rightHandWorldLandmarks, (packet) =>
            {
                return packet.Get(LandmarkList.Parser);
            });
            _ = TryGetValue(results.Item7.packet, out var poseWorldLandmarks, (packet) =>
            {
                return packet.Get(LandmarkList.Parser);
            });
            _ = TryGetValue(results.Item8.packet, out var segmentationMask, (packet) =>
            {
                return packet.Get();
            });
            _ = TryGetValue(results.Item9.packet, out var poseRoi, (packet) =>
            {
                return packet.Get(NormalizedRect.Parser);
            });

            return new HolisticPHTrackingResult(poseDetection, poseLandmarks, leftHandLandmarks, rightHandLandmarks, poseWorldLandmarks, segmentationMask, poseRoi,
                leftHandWorldLandmarks, rightHandWorldLandmarks);
        }
        ...
        protected override void ConfigureCalculatorGraph(CalculatorGraphConfig config)
        {
            ...
            _leftHandWorldLandmarksStream = new OutputStream<LandmarkList>(calculatorGraph, _LeftHandWorldLandmarksStreamName, true);
            _rightHandLandmarksStream = new OutputStream<NormalizedLandmarkList>(calculatorGraph, _RightHandLandmarksStreamName, true);
            _rightHandWorldLandmarksStream = new OutputStream<LandmarkList>(calculatorGraph, _RightHandWorldLandmarksStreamName, true);
